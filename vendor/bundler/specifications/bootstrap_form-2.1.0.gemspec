# -*- encoding: utf-8 -*-
# stub: bootstrap_form 2.1.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.date = "2014-04-01"
  s.description = "bootstrap_form is a rails form builder that makes it super easy to create beautiful-looking forms using Twitter Bootstrapi 3+"
